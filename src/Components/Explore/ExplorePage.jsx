...
const exploreData = [
  ...
  { id: 10, img: "https://picsum.photos/400/400?random=110", likes: "3k", comments: "40" },
  { id: 11, img: "https://picsum.photos/400/400?random=111", likes: "6k", comments: "75", isVideo: true },
  { id: 12, img: "https://picsum.photos/400/400?random=112", likes: "9k", comments: "130", isCarousel: true },
];
      ...
      <div className="explore-grid">
        {exploreData.map((item) => (
          <div key={item.id} className={`explore-item ${item.isTall ? 'tall' : ''}`}>
            ...
            {item.isVideo && (
              <div className="post-type-icon">
                <svg viewBox="0 0 24 24" fill="white" width="18" height="18">
                  <path d="M17.77 10.32l-1.2-.5L18 9.06a3.74 3.74 0 00-3.5-6.62L6.66 5.5A3.74 3.74 0 004.5 9.62v4.91a3.74 3.74 0 003.74 3.74h6.52a3.74 3.74 0 003.5-2.44l1.51-.63a1.88 1.88 0 000-3.44zM16.26 14a1.74 1.74 0 01-1.5.88H8.24a1.74 1.74 0 01-1.74-1.74V9.62a1.74 1.74 0 011-1.58l7.84-3.06a1.74 1.74 0 012.16 1.65v6.14z"/>
                </svg>
              </div>
            )}
            ...
            {item.isCarousel && (
              <div className="post-type-icon">
                <svg viewBox="0 0 48 48" fill="white" width="18" height="18">
                  <path d="M34.8 29.7V11c0-2.9-2.3-5.2-5.2-5.2H11c-2.9 0-5.2 2.3-5.2 5.2v18.7c0 2.9 2.3 5.2 5.2 5.2h18.7c2.8-.1 5.1-2.4 5.1-5.2zM27.2 29.6v-7.2l5.2 3.6-5.2 3.6zM42 12.7v21.6"/>
                </svg>
              </div>
            )}
